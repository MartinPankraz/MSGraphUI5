sap.ui.define([
	"sap/ui/test/Opa5",
	"azure/graph/example/msgraphui/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("azure.graph.example.msgraphui.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "azure.graph.example.msgraphui",
					async: true
				},
				hash: oOptions.hash,
