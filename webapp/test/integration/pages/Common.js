sap.ui.define([
	...
	return Opa5.extend("azure.graph.example.msgraphui.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["azure/graph/example/msgraphui/localService/mockserver"], function (mockserver) {
