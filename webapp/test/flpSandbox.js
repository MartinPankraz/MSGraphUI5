		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori MS Graph Integration",
									"targetURL": "#FioriMSGraphIntegration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FioriMSGraphIntegration-display": {
								"semanticObject": "FioriMSGraphIntegration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=azure.graph.example.msgraphui",
									"url": sap.ui.require.toUrl("azure/graph/example/msgraphui")
								}
							}
						}
					}
